...
function rtp(){
    const playRTP = playState.totalBets > 0 ? (playState.totalWinnings / playState.totalBets) * 100 : 0;
    const simRTP = simulationState.totalBets > 0 ? (simulationState.totalWinnings / simulationState.totalBets) * 100 : 0;
